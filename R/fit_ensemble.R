...
#'as the second. The observations / model outputs should be a `matrix` (or `data.frame`) with each
#'column giving a different species and each row a different year. Rows should be named with
