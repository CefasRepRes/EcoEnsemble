...
#'  * If `'hierarchical_beta_conjugate'` is selected, then the `cor_params` slot should be a `numeric` of length 3 giving the hyperparameters \eqn{p, q, k} of the beta conjugate distribution, whose density is defined up to a constant of proportionality by
