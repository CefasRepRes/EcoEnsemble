...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(453, 451, "end", "model_ensemble_model");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("ind_st_var", "(logical_neq(form_prior_ind_st, 3) ? N : 0 )", (logical_neq(form_prior_ind_st, 3) ? N : 0 ));
            validate_non_negative_index("ind_st_var", "M", M);
            num_params_r__ += ((logical_neq(form_prior_ind_st, 3) ? N : 0 ) * M);
            current_statement_begin__ = 244;
            validate_non_negative_index("log_ind_st_var", "(logical_eq(form_prior_ind_st, 3) ? N : 0 )", (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
            validate_non_negative_index("log_ind_st_var", "M", M);
            num_params_r__ += ((logical_eq(form_prior_ind_st, 3) ? N : 0 ) * M);
            ...
            validate_non_negative_index("prior_ind_st_cor_hierarchical_beta_params", "(logical_eq(form_prior_ind_st, 3) ? N : 0 )", (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
            num_params_r__ += ((logical_eq(form_prior_ind_st, 3) ? N : 0 ) * (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
            current_statement_begin__ = 276;
            validate_non_negative_index("prior_ind_st_var_hierarchical_sigma_2", "(logical_eq(form_prior_ind_st, 3) ? N : 0 )", (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
            num_params_r__ += (logical_eq(form_prior_ind_st, 3) ? N : 0 );
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("ind_st_var", "(logical_neq(form_prior_ind_st, 3) ? N : 0 )", (logical_neq(form_prior_ind_st, 3) ? N : 0 ));
        validate_non_negative_index("ind_st_var", "M", M);
        context__.validate_dims("parameter initialization", "ind_st_var", "vector_d", context__.to_vec(M,(logical_neq(form_prior_ind_st, 3) ? N : 0 )));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > ind_st_var(M, Eigen::Matrix<double, Eigen::Dynamic, 1>((logical_neq(form_prior_ind_st, 3) ? N : 0 )));
        size_t ind_st_var_j_1_max__ = (logical_neq(form_prior_ind_st, 3) ? N : 0 );
        ...
        validate_non_negative_index("log_ind_st_var", "(logical_eq(form_prior_ind_st, 3) ? N : 0 )", (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
        validate_non_negative_index("log_ind_st_var", "M", M);
        context__.validate_dims("parameter initialization", "log_ind_st_var", "vector_d", context__.to_vec(M,(logical_eq(form_prior_ind_st, 3) ? N : 0 )));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > log_ind_st_var(M, Eigen::Matrix<double, Eigen::Dynamic, 1>((logical_eq(form_prior_ind_st, 3) ? N : 0 )));
        size_t log_ind_st_var_j_1_max__ = (logical_eq(form_prior_ind_st, 3) ? N : 0 );
        ...
        validate_non_negative_index("prior_ind_st_cor_hierarchical_beta_params", "(logical_eq(form_prior_ind_st, 3) ? N : 0 )", (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
        validate_non_negative_index("prior_ind_st_cor_hierarchical_beta_params", "(logical_eq(form_prior_ind_st, 3) ? N : 0 )", (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
        context__.validate_dims("parameter initialization", "prior_ind_st_cor_hierarchical_beta_params", "matrix_d", context__.to_vec((logical_eq(form_prior_ind_st, 3) ? N : 0 ),(logical_eq(form_prior_ind_st, 3) ? N : 0 )));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> prior_ind_st_cor_hierarchical_beta_params((logical_eq(form_prior_ind_st, 3) ? N : 0 ), (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
        ...
        current_statement_begin__ = 276;
        if (!(context__.contains_r("prior_ind_st_var_hierarchical_sigma_2")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable prior_ind_st_var_hierarchical_sigma_2 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("prior_ind_st_var_hierarchical_sigma_2");
        pos__ = 0U;
        validate_non_negative_index("prior_ind_st_var_hierarchical_sigma_2", "(logical_eq(form_prior_ind_st, 3) ? N : 0 )", (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
        context__.validate_dims("parameter initialization", "prior_ind_st_var_hierarchical_sigma_2", "vector_d", context__.to_vec((logical_eq(form_prior_ind_st, 3) ? N : 0 )));
        Eigen::Matrix<double, Eigen::Dynamic, 1> prior_ind_st_var_hierarchical_sigma_2((logical_eq(form_prior_ind_st, 3) ? N : 0 ));
        size_t prior_ind_st_var_hierarchical_sigma_2_j_1_max__ = (logical_eq(form_prior_ind_st, 3) ? N : 0 );
        for (size_t j_1__ = 0; j_1__ < prior_ind_st_var_hierarchical_sigma_2_j_1_max__; ++j_1__) {
            prior_ind_st_var_hierarchical_sigma_2(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lb_unconstrain(0, prior_ind_st_var_hierarchical_sigma_2);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable prior_ind_st_var_hierarchical_sigma_2: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (size_t d_0__ = 0; d_0__ < ind_st_var_d_0_max__; ++d_0__) {
                if (jacobian__)
                    ind_st_var.push_back(in__.vector_lb_constrain(0, (logical_neq(form_prior_ind_st, 3) ? N : 0 ), lp__));
                else
                    ind_st_var.push_back(in__.vector_lb_constrain(0, (logical_neq(form_prior_ind_st, 3) ? N : 0 )));
            }
            current_statement_begin__ = 244;
            ...
            for (size_t d_0__ = 0; d_0__ < log_ind_st_var_d_0_max__; ++d_0__) {
                if (jacobian__)
                    log_ind_st_var.push_back(in__.vector_constrain((logical_eq(form_prior_ind_st, 3) ? N : 0 ), lp__));
                else
                    log_ind_st_var.push_back(in__.vector_constrain((logical_eq(form_prior_ind_st, 3) ? N : 0 )));
            }
            current_statement_begin__ = 246;
            ...
            if (jacobian__)
                prior_ind_st_cor_hierarchical_beta_params = in__.matrix_lb_constrain(0, (logical_eq(form_prior_ind_st, 3) ? N : 0 ), (logical_eq(form_prior_ind_st, 3) ? N : 0 ), lp__);
            else
                prior_ind_st_cor_hierarchical_beta_params = in__.matrix_lb_constrain(0, (logical_eq(form_prior_ind_st, 3) ? N : 0 ), (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
            current_statement_begin__ = 276;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> prior_ind_st_var_hierarchical_sigma_2;
            (void) prior_ind_st_var_hierarchical_sigma_2;  // dummy to suppress unused var warning
            if (jacobian__)
                prior_ind_st_var_hierarchical_sigma_2 = in__.vector_lb_constrain(0, (logical_eq(form_prior_ind_st, 3) ? N : 0 ), lp__);
            else
                prior_ind_st_var_hierarchical_sigma_2 = in__.vector_lb_constrain(0, (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
            ...
            for (int i = 1; i <= M; ++i) {
                ...
                if (as_bool(logical_eq(form_prior_ind_st, 3))) {
                    ...
                    stan::model::assign(ind_st_var_2, 
                                ...
                                stan::math::exp(add(diagonal(prior_ind_st_cor_hierarchical_beta_params), elt_multiply(stan::math::sqrt(prior_ind_st_var_hierarchical_sigma_2), get_base1(log_ind_st_var, i, "log_ind_st_var", 1)))), 
                                "assigning variable ind_st_var_2");
                } else {
                    current_statement_begin__ = 321;
                    stan::model::assign(ind_st_var_2, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                get_base1(ind_st_var, i, "ind_st_var", 1), 
                                "assigning variable ind_st_var_2");
                }
            ...
            lp_accum__.add(gamma_log<propto__>(y_init_var, prior_y_init_var_a, prior_y_init_var_b));
            ...
            for (int i = 1; i <= M; ++i) {
                ...
                if (as_bool(logical_eq(form_prior_ind_st, 3))) {
                    ...
                    lp_accum__.add(normal_log<propto__>(diagonal(prior_ind_st_cor_hierarchical_beta_params), get_base1(prior_ind_st_var_hierarchical_hyperparams, 1, "prior_ind_st_var_hierarchical_hyperparams", 1), get_base1(prior_ind_st_var_hierarchical_hyperparams, 2, "prior_ind_st_var_hierarchical_hyperparams", 1)));
                    current_statement_begin__ = 419;
                    lp_accum__.add(inv_gamma_log<propto__>(get_base1(prior_ind_st_var_hierarchical_sigma_2, i, "prior_ind_st_var_hierarchical_sigma_2", 1), get_base1(prior_ind_st_var_hierarchical_hyperparams, 3, "prior_ind_st_var_hierarchical_hyperparams", 1), get_base1(prior_ind_st_var_hierarchical_hyperparams, 4, "prior_ind_st_var_hierarchical_hyperparams", 1)));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("prior_ind_st_var_hierarchical_sigma_2");
    ...
    void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
        ...
        dims__.resize(0);
        dims__.push_back(M);
        dims__.push_back((logical_neq(form_prior_ind_st, 3) ? N : 0 ));
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(M);
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> prior_ind_st_cor_hierarchical_beta_params = in__.matrix_lb_constrain(0, (logical_eq(form_prior_ind_st, 3) ? N : 0 ), (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
        size_t prior_ind_st_cor_hierarchical_beta_params_j_2_max__ = (logical_eq(form_prior_ind_st, 3) ? N : 0 );
        size_t prior_ind_st_cor_hierarchical_beta_params_j_1_max__ = (logical_eq(form_prior_ind_st, 3) ? N : 0 );
        for (size_t j_2__ = 0; j_2__ < prior_ind_st_cor_hierarchical_beta_params_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < prior_ind_st_cor_hierarchical_beta_params_j_1_max__; ++j_1__) {
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> prior_ind_st_var_hierarchical_sigma_2 = in__.vector_lb_constrain(0, (logical_eq(form_prior_ind_st, 3) ? N : 0 ));
        size_t prior_ind_st_var_hierarchical_sigma_2_j_1_max__ = (logical_eq(form_prior_ind_st, 3) ? N : 0 );
        for (size_t j_1__ = 0; j_1__ < prior_ind_st_var_hierarchical_sigma_2_j_1_max__; ++j_1__) {
            vars__.push_back(prior_ind_st_var_hierarchical_sigma_2(j_1__));
        }
        double lp__ = 0.0;
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < prior_ind_st_var_hierarchical_sigma_2_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "prior_ind_st_var_hierarchical_sigma_2" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        if (!include_gqs__ && !include_tparams__) return;
        if (include_tparams__) {
