...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(332, 330, "end", "model_ensemble_model");
    return reader;
}
...
private:
        ...
        int form_prior_ind_st_cor;
        int form_prior_ind_lt_cor;
        int form_prior_sha_st_cor;
        double prior_ind_st_var_a;
        double prior_ind_st_var_b;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "form_prior_ind_st_cor", "int", context__.to_vec());
            form_prior_ind_st_cor = int(0);
            vals_i__ = context__.vals_i("form_prior_ind_st_cor");
            pos__ = 0;
            form_prior_ind_st_cor = vals_i__[pos__++];
            check_greater_or_equal(function__, "form_prior_ind_st_cor", form_prior_ind_st_cor, 0);
            check_less_or_equal(function__, "form_prior_ind_st_cor", form_prior_ind_st_cor, 2);
            current_statement_begin__ = 103;
            context__.validate_dims("data initialization", "form_prior_ind_lt_cor", "int", context__.to_vec());
            form_prior_ind_lt_cor = int(0);
            vals_i__ = context__.vals_i("form_prior_ind_lt_cor");
            pos__ = 0;
            form_prior_ind_lt_cor = vals_i__[pos__++];
            check_greater_or_equal(function__, "form_prior_ind_lt_cor", form_prior_ind_lt_cor, 0);
            check_less_or_equal(function__, "form_prior_ind_lt_cor", form_prior_ind_lt_cor, 2);
            current_statement_begin__ = 104;
            context__.validate_dims("data initialization", "form_prior_sha_st_cor", "int", context__.to_vec());
            form_prior_sha_st_cor = int(0);
            vals_i__ = context__.vals_i("form_prior_sha_st_cor");
            pos__ = 0;
            form_prior_sha_st_cor = vals_i__[pos__++];
            check_greater_or_equal(function__, "form_prior_sha_st_cor", form_prior_sha_st_cor, 0);
            check_less_or_equal(function__, "form_prior_sha_st_cor", form_prior_sha_st_cor, 2);
            current_statement_begin__ = 111;
            context__.validate_dims("data initialization", "prior_ind_st_var_a", "double", context__.to_vec());
            prior_ind_st_var_a = double(0);
            vals_r__ = context__.vals_r("prior_ind_st_var_a");
            pos__ = 0;
            prior_ind_st_var_a = vals_r__[pos__++];
            current_statement_begin__ = 112;
            context__.validate_dims("data initialization", "prior_ind_st_var_b", "double", context__.to_vec());
            prior_ind_st_var_b = double(0);
            vals_r__ = context__.vals_r("prior_ind_st_var_b");
            pos__ = 0;
            prior_ind_st_var_b = vals_r__[pos__++];
            current_statement_begin__ = 114;
            validate_non_negative_index("prior_ind_st_cor_lkj", "(logical_eq(form_prior_ind_st_cor, 0) ? 1 : 0 )", (logical_eq(form_prior_ind_st_cor, 0) ? 1 : 0 ));
            context__.validate_dims("data initialization", "prior_ind_st_cor_lkj", "double", context__.to_vec((logical_eq(form_prior_ind_st_cor, 0) ? 1 : 0 )));
            prior_ind_st_cor_lkj = std::vector<double>((logical_eq(form_prior_ind_st_cor, 0) ? 1 : 0 ), double(0));
            vals_r__ = context__.vals_r("prior_ind_st_cor_lkj");
            pos__ = 0;
            size_t prior_ind_st_cor_lkj_k_0_max__ = (logical_eq(form_prior_ind_st_cor, 0) ? 1 : 0 );
            for (size_t k_0__ = 0; k_0__ < prior_ind_st_cor_lkj_k_0_max__; ++k_0__) {
                prior_ind_st_cor_lkj[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 115;
            validate_non_negative_index("prior_ind_st_cor_wish_sigma", "(logical_eq(form_prior_ind_st_cor, 1) ? N : 0 )", (logical_eq(form_prior_ind_st_cor, 1) ? N : 0 ));
            validate_non_negative_index("prior_ind_st_cor_wish_sigma", "(logical_eq(form_prior_ind_st_cor, 1) ? N : 0 )", (logical_eq(form_prior_ind_st_cor, 1) ? N : 0 ));
            context__.validate_dims("data initialization", "prior_ind_st_cor_wish_sigma", "matrix_d", context__.to_vec((logical_eq(form_prior_ind_st_cor, 1) ? N : 0 ),(logical_eq(form_prior_ind_st_cor, 1) ? N : 0 )));
            prior_ind_st_cor_wish_sigma = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>((logical_eq(form_prior_ind_st_cor, 1) ? N : 0 ), (logical_eq(form_prior_ind_st_cor, 1) ? N : 0 ));
            vals_r__ = context__.vals_r("prior_ind_st_cor_wish_sigma");
            pos__ = 0;
            size_t prior_ind_st_cor_wish_sigma_j_2_max__ = (logical_eq(form_prior_ind_st_cor, 1) ? N : 0 );
            size_t prior_ind_st_cor_wish_sigma_j_1_max__ = (logical_eq(form_prior_ind_st_cor, 1) ? N : 0 );
            ...
            validate_non_negative_index("prior_ind_st_cor_wish_nu", "(logical_eq(form_prior_ind_st_cor, 1) ? 1 : 0 )", (logical_eq(form_prior_ind_st_cor, 1) ? 1 : 0 ));
            context__.validate_dims("data initialization", "prior_ind_st_cor_wish_nu", "double", context__.to_vec((logical_eq(form_prior_ind_st_cor, 1) ? 1 : 0 )));
            prior_ind_st_cor_wish_nu = std::vector<double>((logical_eq(form_prior_ind_st_cor, 1) ? 1 : 0 ), double(0));
            vals_r__ = context__.vals_r("prior_ind_st_cor_wish_nu");
            pos__ = 0;
            size_t prior_ind_st_cor_wish_nu_k_0_max__ = (logical_eq(form_prior_ind_st_cor, 1) ? 1 : 0 );
            for (size_t k_0__ = 0; k_0__ < prior_ind_st_cor_wish_nu_k_0_max__; ++k_0__) {
                prior_ind_st_cor_wish_nu[k_0__] = vals_r__[pos__++];
            }
            size_t prior_ind_st_cor_wish_nu_i_0_max__ = (logical_eq(form_prior_ind_st_cor, 1) ? 1 : 0 );
            ...
            validate_non_negative_index("prior_ind_st_cor_beta_1", "(logical_eq(form_prior_ind_st_cor, 2) ? N : 0 )", (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ));
            validate_non_negative_index("prior_ind_st_cor_beta_1", "(logical_eq(form_prior_ind_st_cor, 2) ? N : 0 )", (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ));
            context__.validate_dims("data initialization", "prior_ind_st_cor_beta_1", "matrix_d", context__.to_vec((logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ),(logical_eq(form_prior_ind_st_cor, 2) ? N : 0 )));
            prior_ind_st_cor_beta_1 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>((logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ), (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ));
            vals_r__ = context__.vals_r("prior_ind_st_cor_beta_1");
            pos__ = 0;
            size_t prior_ind_st_cor_beta_1_j_2_max__ = (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 );
            size_t prior_ind_st_cor_beta_1_j_1_max__ = (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 );
            ...
            validate_non_negative_index("prior_ind_st_cor_beta_2", "(logical_eq(form_prior_ind_st_cor, 2) ? N : 0 )", (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ));
            validate_non_negative_index("prior_ind_st_cor_beta_2", "(logical_eq(form_prior_ind_st_cor, 2) ? N : 0 )", (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ));
            context__.validate_dims("data initialization", "prior_ind_st_cor_beta_2", "matrix_d", context__.to_vec((logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ),(logical_eq(form_prior_ind_st_cor, 2) ? N : 0 )));
            prior_ind_st_cor_beta_2 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>((logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ), (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 ));
            vals_r__ = context__.vals_r("prior_ind_st_cor_beta_2");
            pos__ = 0;
            size_t prior_ind_st_cor_beta_2_j_2_max__ = (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 );
            size_t prior_ind_st_cor_beta_2_j_1_max__ = (logical_eq(form_prior_ind_st_cor, 2) ? N : 0 );
            ...
            validate_non_negative_index("prior_ind_lt_cor_lkj", "(logical_eq(form_prior_ind_lt_cor, 0) ? 1 : 0 )", (logical_eq(form_prior_ind_lt_cor, 0) ? 1 : 0 ));
            context__.validate_dims("data initialization", "prior_ind_lt_cor_lkj", "double", context__.to_vec((logical_eq(form_prior_ind_lt_cor, 0) ? 1 : 0 )));
            prior_ind_lt_cor_lkj = std::vector<double>((logical_eq(form_prior_ind_lt_cor, 0) ? 1 : 0 ), double(0));
            vals_r__ = context__.vals_r("prior_ind_lt_cor_lkj");
            pos__ = 0;
            size_t prior_ind_lt_cor_lkj_k_0_max__ = (logical_eq(form_prior_ind_lt_cor, 0) ? 1 : 0 );
            for (size_t k_0__ = 0; k_0__ < prior_ind_lt_cor_lkj_k_0_max__; ++k_0__) {
                prior_ind_lt_cor_lkj[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 124;
            validate_non_negative_index("prior_ind_lt_cor_wish_sigma", "(logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 )", (logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 ));
            validate_non_negative_index("prior_ind_lt_cor_wish_sigma", "(logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 )", (logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 ));
            context__.validate_dims("data initialization", "prior_ind_lt_cor_wish_sigma", "matrix_d", context__.to_vec((logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 ),(logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 )));
            prior_ind_lt_cor_wish_sigma = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>((logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 ), (logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 ));
            vals_r__ = context__.vals_r("prior_ind_lt_cor_wish_sigma");
            pos__ = 0;
            size_t prior_ind_lt_cor_wish_sigma_j_2_max__ = (logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 );
            size_t prior_ind_lt_cor_wish_sigma_j_1_max__ = (logical_eq(form_prior_ind_lt_cor, 1) ? N : 0 );
            ...
            validate_non_negative_index("prior_ind_lt_cor_wish_nu", "(logical_eq(form_prior_ind_lt_cor, 1) ? 1 : 0 )", (logical_eq(form_prior_ind_lt_cor, 1) ? 1 : 0 ));
            context__.validate_dims("data initialization", "prior_ind_lt_cor_wish_nu", "double", context__.to_vec((logical_eq(form_prior_ind_lt_cor, 1) ? 1 : 0 )));
            prior_ind_lt_cor_wish_nu = std::vector<double>((logical_eq(form_prior_ind_lt_cor, 1) ? 1 : 0 ), double(0));
            vals_r__ = context__.vals_r("prior_ind_lt_cor_wish_nu");
            pos__ = 0;
            size_t prior_ind_lt_cor_wish_nu_k_0_max__ = (logical_eq(form_prior_ind_lt_cor, 1) ? 1 : 0 );
            for (size_t k_0__ = 0; k_0__ < prior_ind_lt_cor_wish_nu_k_0_max__; ++k_0__) {
                prior_ind_lt_cor_wish_nu[k_0__] = vals_r__[pos__++];
            }
            size_t prior_ind_lt_cor_wish_nu_i_0_max__ = (logical_eq(form_prior_ind_lt_cor, 1) ? 1 : 0 );
            ...
            validate_non_negative_index("prior_ind_lt_cor_beta_1", "(logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 )", (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ));
            validate_non_negative_index("prior_ind_lt_cor_beta_1", "(logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 )", (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ));
            context__.validate_dims("data initialization", "prior_ind_lt_cor_beta_1", "matrix_d", context__.to_vec((logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ),(logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 )));
            prior_ind_lt_cor_beta_1 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>((logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ), (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ));
            vals_r__ = context__.vals_r("prior_ind_lt_cor_beta_1");
            pos__ = 0;
            size_t prior_ind_lt_cor_beta_1_j_2_max__ = (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 );
            size_t prior_ind_lt_cor_beta_1_j_1_max__ = (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 );
            ...
            validate_non_negative_index("prior_ind_lt_cor_beta_2", "(logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 )", (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ));
            validate_non_negative_index("prior_ind_lt_cor_beta_2", "(logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 )", (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ));
            context__.validate_dims("data initialization", "prior_ind_lt_cor_beta_2", "matrix_d", context__.to_vec((logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ),(logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 )));
            prior_ind_lt_cor_beta_2 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>((logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ), (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 ));
            vals_r__ = context__.vals_r("prior_ind_lt_cor_beta_2");
            pos__ = 0;
            size_t prior_ind_lt_cor_beta_2_j_2_max__ = (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 );
            size_t prior_ind_lt_cor_beta_2_j_1_max__ = (logical_eq(form_prior_ind_lt_cor, 2) ? N : 0 );
            ...
            context__.validate_dims("data initialization", "prior_sha_st_var_exp", "double", context__.to_vec());
            prior_sha_st_var_exp = double(0);
            vals_r__ = context__.vals_r("prior_sha_st_var_exp");
            pos__ = 0;
            prior_sha_st_var_exp = vals_r__[pos__++];
            check_greater_or_equal(function__, "prior_sha_st_var_exp", prior_sha_st_var_exp, 0);
            current_statement_begin__ = 133;
            validate_non_negative_index("prior_sha_st_cor_lkj", "(logical_eq(form_prior_sha_st_cor, 0) ? 1 : 0 )", (logical_eq(form_prior_sha_st_cor, 0) ? 1 : 0 ));
            context__.validate_dims("data initialization", "prior_sha_st_cor_lkj", "double", context__.to_vec((logical_eq(form_prior_sha_st_cor, 0) ? 1 : 0 )));
            prior_sha_st_cor_lkj = std::vector<double>((logical_eq(form_prior_sha_st_cor, 0) ? 1 : 0 ), double(0));
            vals_r__ = context__.vals_r("prior_sha_st_cor_lkj");
            pos__ = 0;
            size_t prior_sha_st_cor_lkj_k_0_max__ = (logical_eq(form_prior_sha_st_cor, 0) ? 1 : 0 );
            for (size_t k_0__ = 0; k_0__ < prior_sha_st_cor_lkj_k_0_max__; ++k_0__) {
                prior_sha_st_cor_lkj[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 134;
            validate_non_negative_index("prior_sha_st_cor_wish_sigma", "(logical_eq(form_prior_sha_st_cor, 1) ? N : 0 )", (logical_eq(form_prior_sha_st_cor, 1) ? N : 0 ));
            validate_non_negative_index("prior_sha_st_cor_wish_sigma", "(logical_eq(form_prior_sha_st_cor, 1) ? N : 0 )", (logical_eq(form_prior_sha_st_cor, 1) ? N : 0 ));
            context__.validate_dims("data initialization", "prior_sha_st_cor_wish_sigma", "matrix_d", context__.to_vec((logical_eq(form_prior_sha_st_cor, 1) ? N : 0 ),(logical_eq(form_prior_sha_st_cor, 1) ? N : 0 )));
            prior_sha_st_cor_wish_sigma = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>((logical_eq(form_prior_sha_st_cor, 1) ? N : 0 ), (logical_eq(form_prior_sha_st_cor, 1) ? N : 0 ));
            vals_r__ = context__.vals_r("prior_sha_st_cor_wish_sigma");
            pos__ = 0;
            size_t prior_sha_st_cor_wish_sigma_j_2_max__ = (logical_eq(form_prior_sha_st_cor, 1) ? N : 0 );
            size_t prior_sha_st_cor_wish_sigma_j_1_max__ = (logical_eq(form_prior_sha_st_cor, 1) ? N : 0 );
            ...
            validate_non_negative_index("prior_sha_st_cor_wish_nu", "(logical_eq(form_prior_sha_st_cor, 1) ? 1 : 0 )", (logical_eq(form_prior_sha_st_cor, 1) ? 1 : 0 ));
            context__.validate_dims("data initialization", "prior_sha_st_cor_wish_nu", "double", context__.to_vec((logical_eq(form_prior_sha_st_cor, 1) ? 1 : 0 )));
            prior_sha_st_cor_wish_nu = std::vector<double>((logical_eq(form_prior_sha_st_cor, 1) ? 1 : 0 ), double(0));
            vals_r__ = context__.vals_r("prior_sha_st_cor_wish_nu");
            pos__ = 0;
            size_t prior_sha_st_cor_wish_nu_k_0_max__ = (logical_eq(form_prior_sha_st_cor, 1) ? 1 : 0 );
            for (size_t k_0__ = 0; k_0__ < prior_sha_st_cor_wish_nu_k_0_max__; ++k_0__) {
                prior_sha_st_cor_wish_nu[k_0__] = vals_r__[pos__++];
            }
            size_t prior_sha_st_cor_wish_nu_i_0_max__ = (logical_eq(form_prior_sha_st_cor, 1) ? 1 : 0 );
            ...
            validate_non_negative_index("prior_sha_st_cor_beta_1", "(logical_eq(form_prior_sha_st_cor, 2) ? N : 0 )", (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ));
            validate_non_negative_index("prior_sha_st_cor_beta_1", "(logical_eq(form_prior_sha_st_cor, 2) ? N : 0 )", (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ));
            context__.validate_dims("data initialization", "prior_sha_st_cor_beta_1", "matrix_d", context__.to_vec((logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ),(logical_eq(form_prior_sha_st_cor, 2) ? N : 0 )));
            prior_sha_st_cor_beta_1 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>((logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ), (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ));
            vals_r__ = context__.vals_r("prior_sha_st_cor_beta_1");
            pos__ = 0;
            size_t prior_sha_st_cor_beta_1_j_2_max__ = (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 );
            size_t prior_sha_st_cor_beta_1_j_1_max__ = (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 );
            ...
            validate_non_negative_index("prior_sha_st_cor_beta_2", "(logical_eq(form_prior_sha_st_cor, 2) ? N : 0 )", (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ));
            validate_non_negative_index("prior_sha_st_cor_beta_2", "(logical_eq(form_prior_sha_st_cor, 2) ? N : 0 )", (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ));
            context__.validate_dims("data initialization", "prior_sha_st_cor_beta_2", "matrix_d", context__.to_vec((logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ),(logical_eq(form_prior_sha_st_cor, 2) ? N : 0 )));
            prior_sha_st_cor_beta_2 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>((logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ), (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 ));
            vals_r__ = context__.vals_r("prior_sha_st_cor_beta_2");
            pos__ = 0;
            size_t prior_sha_st_cor_beta_2_j_2_max__ = (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 );
            size_t prior_sha_st_cor_beta_2_j_1_max__ = (logical_eq(form_prior_sha_st_cor, 2) ? N : 0 );
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(SIGMA_mu,diag_post_multiply(diag_pre_multiply(sha_st_var, sha_st_cor), sha_st_var));
            ...
            lp_accum__.add(normal_log<propto__>(y_init_mean, 0, 10));
            current_statement_begin__ = 282;
            lp_accum__.add(inv_gamma_log<propto__>(y_init_var, 10, 1));
            current_statement_begin__ = 283;
            lp_accum__.add(inv_wishart_log<propto__>(SIGMA_t, 10, diag_matrix(rep_vector(1.0, N))));
            current_statement_begin__ = 286;
            lp_accum__.add(std_normal_log<propto__>(sha_lt_raw));
            current_statement_begin__ = 287;
            lp_accum__.add(exponential_log<propto__>(sha_st_var, prior_sha_st_var_exp));
            current_statement_begin__ = 289;
            if (as_bool(logical_eq(form_prior_sha_st_cor, 0))) {
                current_statement_begin__ = 290;
                lp_accum__.add(lkj_corr_log<propto__>(sha_st_cor, get_base1(prior_sha_st_cor_lkj, 1, "prior_sha_st_cor_lkj", 1)));
            } else if (as_bool(logical_eq(form_prior_sha_st_cor, 1))) {
            ...
            for (int i = 1; i <= M; ++i) {
                ...
                if (as_bool(logical_eq(form_prior_ind_st_cor, 0))) {
                ...
                } else if (as_bool(logical_eq(form_prior_ind_st_cor, 1))) {
