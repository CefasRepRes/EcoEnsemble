...
static constexpr std::array<const char*, 322> locations_array__ =
...
public:
  ...
  model_ensemble_model(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_ensemble_model_namespace::model_ensemble_model";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_ensemble_model_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_ensemble_model_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((((((((M * N) + (M * N)) + ((M * N) * N))
      + (M * N)) + N) + (N * N)) + N) + N) + (N * N)) + N) + (N * N));
    const size_t num_transformed = emit_transformed_parameters *
      ((((((((((((((((M * N) * N) + (M * N)) + N) + (M * N)) + N) + (N * N))
      + (N * N)) + x_hat_1dim__) + (SIGMA_init_1dim__ * SIGMA_init_2dim__)) +
      N) + (N * N)) + (SIGMA_1dim__ * SIGMA_2dim__)) +
