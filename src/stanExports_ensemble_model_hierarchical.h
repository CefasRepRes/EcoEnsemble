...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ensemble_model_hierarchical");
    reader.add_event(423, 421, "end", "model_ensemble_model_hierarchical");
    return reader;
}
...
class model_ensemble_model_hierarchical
  : public stan::model::model_base_crtp<model_ensemble_model_hierarchical> {
private:
        int N;
        int time;
...
typedef model_ensemble_model_hierarchical_namespace::model_ensemble_model_hierarchical stan_model;
#ifndef USING_R
