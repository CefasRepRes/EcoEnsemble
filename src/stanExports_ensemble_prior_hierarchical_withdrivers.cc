...
#include "stanExports_ensemble_prior_hierarchical_withdrivers.h"

RCPP_MODULE(stan_fit4ensemble_prior_hierarchical_withdrivers_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_ensemble_prior_hierarchical_withdrivers")
