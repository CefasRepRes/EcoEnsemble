...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(332, 330, "end", "model_ensemble_prior");
    return reader;
}
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(form_prior_ind_st, 3))) {
                ...
                lp_accum__.add(inv_gamma_log<propto__>(prior_ind_st_var_hierarchical_sigma_2, get_base1(prior_ind_st_var_hierarchical_hyperparams, 3, "prior_ind_st_var_hierarchical_hyperparams", 1), get_base1(prior_ind_st_var_hierarchical_hyperparams, 4, "prior_ind_st_var_hierarchical_hyperparams", 1)));
